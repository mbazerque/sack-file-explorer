...
export function TabBar() {
  ...
  return (
    ...
    >
      <div data-tauri-drag-region className="flex items-center gap-1 min-w-0 flex-1 overflow-x-auto scrollbar-none h-full pt-1">
        <div data-tauri-drag-region className="flex items-center gap-1 min-w-0 h-full">
          {tabs.map((tab) => {
            ...
            return (
              <div
                ...
                className={`group relative flex items-center gap-2 px-3 py-1 text-xs font-medium rounded-t-lg border-t border-x cursor-pointer transition-all max-w-[180px] shrink-0 h-full ${
                  isActive
